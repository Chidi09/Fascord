  ...
  const services = [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Expedited Air Freight Cargo",
        "Customs Duty Filing Support",
    ...
    },
    {
      ...
      bullets: [
        "Direct Dedicated Vehicle",
        "Instant GPS Courier Tracking",
        "Fragile & High-Value Payloads",
      ...
      <div className="container">
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            From single document envelopes to complete container freight
            payloads, Fascord provides premium transport networks.
          </p>
        </div>
