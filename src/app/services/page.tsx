...
export default function ServicesPage() {
  ...
  const comparisonRows = [
    {
      feature: "Transit Time (UK)",
      express: "1-2 Days",
      freight: "3-7 Days",
      sameday: "Same Day",
    },
    {
      feature: "Transit Time (Intl)",
      express: "1-3 Days",
      freight: "3-14 Days",
      sameday: "N/A",
    },
    {
      feature: "Max Weight per Item",
      express: "30kg",
      freight: "No Limit",
      sameday: "1000kg",
    },
    ...
    {
      feature: "Customs Clearance Help",
      express: "✓",
      freight: "✓",
      sameday: "N/A",
    },
          ...
          <div className="container">
            <div className={styles.heroContent}>
              <h1 className={styles.pageTitle}>
                LOGISTICS SERVICES & COMPARISONS
              </h1>
              <p className={styles.pageSubtitle}>
                State-of-the-art express shipping, global freight distribution,
                and dedicated same-day cargo systems designed around you.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className={styles.comparisonHeader}>
              ...
              <p className={styles.sectionSubtitle}>
                Compare specifications, limits, and timelines of our three
                primary service modules to select your ideal logistics fit.
              </p>
            </div>
            ...
            <div className={styles.tableCta}>
              ...
              <p>
                <strong>Unsure which route fits your cargo?</strong> Our
                logistics dispatch coordinators are available 24/7 to help you
                configure custom cargo shipping networks.{" "}
        ...
        <section className={styles.howToSendSection}>
          <div className="container">
            <div className={styles.howToSendHeader}>
              ...
              <p className={styles.sectionSubtitle}>
                We offer multiple convenient options to drop off your parcels or
            ...
            <div className={styles.methodsGrid}>
              <div className={styles.methodCard}>
                ...
                <h3 className={styles.methodCardTitle}>
                  Fascord Drop-off Points
                </h3>
                <p className={styles.methodCardDesc}>
                  Drop off your parcels at any of our 1,600+ convenient local
                  partner locations across the UK. No account needed.
                </p>
              ...
              <div className={styles.methodCard}>
                ...
                <p className={styles.methodCardDesc}>
                  Schedule a courier collection directly from your home,
                  warehouse, or office. Print labels easily.
                </p>
                <Link href="/quote" className={styles.methodCta}>
              ...
              <div className={styles.methodCard}>
                ...
                <p className={styles.methodCardDesc}>
                  Speak to our dedicated logistics advisors for priority
                  booking, Saturday delivery, or oversized cargo guidance.
                </p>
