        ...
        <div className={styles.grid}>
          ...
          <div className={styles.infoBlock}>
            ...
            <h2 className={styles.title}>
              THE BENCHMARK IN SECURE COURIER & LOGISTICS
            </h2>
            <p className={styles.desc}>
              Fascord Limited builds relationships on trust, accuracy, and
              performance. Whether you are shipping critical legal instruments
              or container-load industrial supplies, we guarantee elite customer
              handling.
            </p>
            <div className={styles.highlightCard}>
              <h4 className={styles.highlightTitle}>OUR PROMISE</h4>
              <p className={styles.highlightText}>
                &ldquo;Frictionless delivery, transparent billing, and immediate
                proactive support. Your cargo is our absolute priority.&rdquo;
              </p>
            </div>
          </div>
