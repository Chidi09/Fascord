...
export default function SendingGiftsPage() {
  const commonProhibited = [
    {
      name: "No Cash / Money",
      desc: "Sovereign coins, paper currency, checks, bank drafts or monetary instruments.",
    },
    {
      name: "No Jewellery > £4,000",
      desc: "Precious metals, stones, or high-value personal jewelry over the set threshold.",
    },
    {
      name: "No Liquid Perfume",
      desc: "Flammable perfumes, aftershaves, and aerosols are classified as hazardous cargo.",
    },
    {
      name: "No Narcotics / CBD",
      desc: "Illegal drugs, cannabis-derived goods, CBD oils, or counterfeit substances.",
    },
    {
      name: "No Cigarettes / Tobacco",
      desc: "Strict import duties and transport regulations apply to all tobacco goods.",
    },
    {
      name: "No Fresh Flowers / Plants",
      desc: "Perishable organic matters and plant biosecurity hazards.",
    },
  ];

  const descriptionsExample = [
    {
      unacceptable: "Gift / Present",
      acceptable: "1x Knitted Woollen Sweater (£45.00)",
    },
    {
      unacceptable: "Electronics",
      acceptable: "1x Refurbished Apple iPhone 13 (Value: £350.00)",
    },
    {
      unacceptable: "Toiletries",
      acceptable: "2x Organic Shea Butter Hand Creams (£12.50 each)",
    },
  ];
        ...
        <section className={styles.hero}>
          ...
          <div className={`container ${styles.heroContainer}`}>
            <span className={styles.badge}>
              <Gift size={14} /> FASCORD GUIDANCE HUB
            </span>
            <h1 className={styles.title}>SENDING GIFTS INTERNATIONALLY</h1>
            <p className={styles.subtitle}>
              What you need to know when sending gifts abroad with Fascord
              Express. Avoid customs delays, understand inspection rules, and
              secure frictionless delivery.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className={styles.warningBox}>
              ...
              <div className={styles.warnText}>
                <strong>CRITICAL CUSTOMS NOTICE:</strong> Standard descriptions
                like &ldquo;Gift&rdquo; or &ldquo;Present&rdquo; are no longer
                accepted by global customs authorities. Accurately list all
                items to prevent severe shipment hold-ups or confiscations.
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className={styles.sectionHeader}>
              ...
              <h2 className={styles.sectionTitle}>
                WHEN SENDING GIFTS ABROAD, KEEP THIS IN MIND
              </h2>
              <p className={styles.sectionSubtitle}>
                Please check what items you cannot send to avoid disappointment.
                Parcels containing prohibited goods will be refused or returned
                at your expense.
              </p>
            </div>
            ...
            <div className={styles.infoGrid}>
              <div className={styles.infoCard}>
                ...
                <p>
                  In line with UK Aviation Security Regulations, all parcels,
                  including gift-wrapped boxes, sealed cards, envelopes, and
                  documents will be opened for manual inspection by a qualified
                  Fascord employee, then resealed as carefully as possible. We
                  strongly recommend using open gift bags.
                </p>
              </div>
              ...
              <div className={styles.infoCard}>
                ...
                <p>
                  You can send a maximum of 2 electronic devices per parcel
                  (such as mobile phones, laptops, or battery-operated toys).
                  These items must be powered down, secured against movement,
                  and packed in strong, rigid packaging to prevent short
                  circuits or accidental activation.
                </p>
              </div>
              ...
              <div className={styles.infoCard}>
                ...
                <p>
                  Customs, duties, and import taxes are always payable by the
                  receiver, even when sending gifts. Check with Fascord Customer
                  Support, as some gifts may be delivered tax-free if the total
                  contents value falls below the receiving country&apos;s
                  specific duty-free threshold.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className={styles.prohibitedSection}>
          <div className="container">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionSubtitle}>
                These popular gift items are either dangerous goods under
                international transport legislation, or compromise the safety of
                our air courier network.
              </p>
            </div>
          ...
          <div className="container">
            <div className={styles.descContainer}>
              <div className={styles.descInfo}>
                ...
                <h2 className={styles.sectionTitle}>
                  CONTENT DESCRIPTIONS MATTER
                </h2>
                <p className={styles.descText}>
                  We cannot accept vague descriptions. All items inside your
                  parcel need to be listed with exact quantities and the
                  replacement value of each. Study these examples to guarantee
                ...
                <table className={styles.table}>
                  ...
                  <tbody>
                    {descriptionsExample.map((row, i) => (
                      <tr key={i}>
                        <td className={styles.unacc}>
                          ✕ &ldquo;{row.unacceptable}&rdquo;
                        </td>
                        <td className={styles.acc}>
                          ✓ &ldquo;{row.acceptable}&rdquo;
                        </td>
                      </tr>
                    ))}
                  </tbody>
        ...
        <section className={styles.faqSection}>
          <div className="container">
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionSubtitle}>
                Everything you need to know about packing, duties, courier
                inspections, and timing for international gifts.
              </p>
            </div>
        ...
        <section className={styles.cta}>
          <div className={`container ${styles.ctaContainer}`}>
            ...
            <p className={styles.ctaDesc}>
              Calculate custom courier rates, select a convenient local Drop-Off
              Point, or book collection at your office.
            </p>
