...
export const handlers = [
  ...
  http.get("/api/track/:id", ({ params }) => {
    ...
    if (id === "FAS-ERROR") {
      return HttpResponse.json(
        {
          error:
            "Tracking number not found. Please verify the code and try again.",
        },
        { status: 404 },
      );
    }
      ...
      steps: [
        {
          ...
          details: "Shipment has been picked up by the courier.",
          completed: true,
        },
        {
          ...
          details: "Shipment processed and prepared for transit.",
          completed: true,
        },
        {
          status: "In Transit",
        ...
        },
        {
          ...
          details: "Customs cleared. Sorting in progress.",
          completed: true,
        },
        {
          status: "Delivered",
          ...
          details: "Delivered and signed by: A. Carter.",
          completed: true,
        },
      ],
    };
    ...
    const mockInTransit: TrackingData = {
      ...
      steps: [
        ...
        },
        {
          ...
          location: "Manchester Sort Centre",
          timestamp: "2026-05-19T20:00:00Z",
          details: "Sorted and loaded onto linehaul vehicle.",
          completed: true,
        },
        {
          ...
          details: "Vehicle en route to Birmingham depot.",
          completed: true,
        },
        {
          status: "Arrived at Delivery Depot",
          location: "Birmingham East Depot",
          timestamp: "2026-05-20T11:30:00Z",
          details: "Received at delivery facility. Sorting to local courier.",
          completed: false,
        },
        {
          ...
          timestamp: "Pending",
          details: "Courier assignment in progress.",
          completed: false,
        },
      ],
    };
  ...
  http.post("/api/quote", async ({ request }) => {
    ...
    // Calculate mock rate
    const baseRate = origin === destination ? 12.5 : 35.0;
    const weightRate = weight * 4.5;
      ...
      options: [
        {
          ...
          description:
            "Next day delivery to most major cities. Real-time end-to-end tracking.",
        },
        {
          id: "fascord-standard",
          ...
          description:
            "Cost-effective logistics for non-urgent shipments. Standard tracking included.",
        },
      ],
    });
  }),
  ...
  http.post("/api/contact", async () => {
    ...
    return HttpResponse.json({
      success: true,
      message:
        "Thank you! Your message has been received. A Fascord logistics agent will contact you within 2 hours.",
    });
  }),
];
