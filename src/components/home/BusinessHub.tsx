        ...
        <div className={styles.gridContainer}>
          ...
          <div className={styles.introBlock}>
            ...
            <p className={styles.desc}>
              Whether you are a scaling e-commerce retailer sending hundreds of
              parcel gifts a week, or a multinational corporation managing heavy
              container cargo - Fascord provides tailored commercial solutions.
            </p>
